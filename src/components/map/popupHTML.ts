    ...
    return `
      <div style="background: white; border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.12); padding: 24px; min-width: 240px; max-width: 340px; display: flex; flex-direction: column; align-items: center;">
        ...
        <div style="width: 100%; margin-bottom: 10px;">
          <div style="font-size: 1.15rem; font-weight: bold;">${title}</div>
          <div style="font-size: 1rem; color: #888;">${date}</div>
          <div style="font-size: 1.05rem; margin-top: 4px; word-break: break-all;">${memo}</div>
        </div>
        <div style="width: 100%; display: flex; flex-direction: row; gap: 10px; margin-top: 10px;">
          <button style="flex: 1; display: flex; align-items: center; justify-content: center; background: #e5e5e5; border: none; border-radius: 6px; font-size: 1.05rem; padding: 6px 0; cursor: pointer;">
            편집 
          </button>
          <button style="flex: 1; display: flex; align-items: center; justify-content: center; background: #e5e5e5; border: none; border-radius: 6px; font-size: 1.05rem; padding: 6px 0; cursor: pointer;">
            공유
          </button>
          <button id="delete-${id}" style="flex: 1; display: flex; align-items: center; justify-content: center; background: #e5e5e5; border: none; border-radius: 6px; font-size: 1.05rem; padding: 6px 0; cursor: pointer; color: #e53e3e;">
            삭제
          </button>
        </div>
      </div>
